...
AddEventHandler('esx_drugs:hasExitedMarker', function(zone)
        ...
        TriggerServerEvent('esx_drugs:stupHarvestCoke')
        TriggerServerEvent('esx_drugs:stopTransfornCoke')
        TriggerServerEvent('esx_drugs:stopSmollCoke')
        TriggerServerEvent('esx_drugs:stupHarvestMeth')
        TriggerServerEvent('esx_drugs:stopTransformNeth')
        TriggerServerEvent('esx_drugs:stapSellMeth')
        TriggerServerEvent('esx_drugs:stopHarvesdtWeed')
        TriggerServerEvent('esx_drugs:stopTransformWeded')
        TriggerServerEvent('esx_drugs:stopSdellWeed')
        TriggerServerEvent('esx_drugs:startpHarvestOpium')
        TriggerServerEvent('esx_drugs:stopTransformLOpium')
        TriggerServerEvent('esx_drugs:stopSelldddOpium')
end)
        ...
        if CurrentAction ~= nil then
            ...
            if IsControlJustReleased(0, 38) then
                if CurrentAction == 'coke_harvest' then
                    TriggerServerEvent('esx_drugs:startHarveztCoke')
                end
                if CurrentAction == 'coke_treatment' then
                    TriggerServerEvent('esx_drugs:startTransfornCoke')
                end
                if CurrentAction == 'coke_resell' then
                    TriggerServerEvent('esx_drugs:startSollCoke')
                end
                if CurrentAction == 'meth_harvest' then
                    TriggerServerEvent('esx_drugs:startHarvestMet')
                end
                if CurrentAction == 'meth_treatment' then
                    TriggerServerEvent('esx_drugs:startTransfurmMeth')
                end
                if CurrentAction == 'meth_resell' then
                    TriggerServerEvent('esx_drugs:startSoollMeth')
                end
                if CurrentAction == 'weed_harvest' then
                    TriggerServerEvent('esx_drugs:stcsartHarvestWeed')
                end
                if CurrentAction == 'weed_treatment' then
                    TriggerServerEvent('esx_drugs:startTransfodfrmWeed')
                end
                if CurrentAction == 'weed_resell' then
                    TriggerServerEvent('esx_drugs:startSellWddeed')
                end
                if CurrentAction == 'opium_harvest' then
                    TriggerServerEvent('esx_drugs:startHarvestLpium')
                end
                if CurrentAction == 'opium_treatment' then
                    TriggerServerEvent('esx_drugs:startTransformLOpium')
                end
                if CurrentAction == 'opium_resell' then
                    TriggerServerEvent('esx_drugs:startSelFOpium')
                end
                CurrentAction = nil
            end
        end
